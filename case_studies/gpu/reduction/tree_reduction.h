  ...
  for (int i = logN; i > 0; i--) {
    ...
    for (int t = 0; t < N; t++) {
      ...
      if (t < (1 << (i - 1))) {
        ...
        __ghost(if_true_hprop_elim, "H := &arr[MINDEX1(N,t)] ~~> tree_sum(A,logN,i)(t), HP := H3");
        ...
        __ghost(if_true_hprop_intro, "H := &arr[MINDEX1(N,t)] ~~> tree_sum(A,logN,i-1)(t), HP := H3");
      } else {
        __ghost(if_false_hprop_rewrite, "H2 := &arr[MINDEX1(N,t)] ~~> tree_sum(A,logN,i-1)(t)");
      }
    }
