...
#pragma omp simd simdlen(8)
        for (int x = 0; x < -4 + w; x++) {
          ...
          float ix2 = ix[2 + (-4 + y) % 4 * (-2 + w) + x];
          float ix3 = ix[(-3 + y) % 4 * (-2 + w) + x];
          float ix4 = ix[1 + (-3 + y) % 4 * (-2 + w) + x];
          float ix5 = ix[2 + (-3 + y) % 4 * (-2 + w) + x];
          float ix6 = ix[(-2 + y) % 4 * (-2 + w) + x];
          float ix7 = ix[1 + (-2 + y) % 4 * (-2 + w) + x];
          float ix8 = ix[2 + (-2 + y) % 4 * (-2 + w) + x];
          float iy0 = iy[(-4 + y) % 4 * (-2 + w) + x];
          float iy1 = iy[1 + (-4 + y) % 4 * (-2 + w) + x];
          float iy2 = iy[2 + (-4 + y) % 4 * (-2 + w) + x];
          float iy3 = iy[(-3 + y) % 4 * (-2 + w) + x];
          float iy4 = iy[1 + (-3 + y) % 4 * (-2 + w) + x];
          float iy5 = iy[2 + (-3 + y) % 4 * (-2 + w) + x];
