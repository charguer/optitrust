    ...
    if (kn == 5) /*@kn*/ {
      ...
      if (cn == 1) /*@cn*/ {
        ...
        __ghost(
            [&]() {
              __consumes(
                  "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 1, __TMP_1 - (-1), "
                  "0)] ~> Cell");
              __produces(
                  "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 1, __TMP_1 + 1, "
                  "0)] ~> Cell");
        ...
        __ghost(
            [&]() {
              __modifies(
                  "for __TMP_2 in 0..n - 1 -> &D[MINDEX2(n, 1, __TMP_2 + 1, "
                  "0)] ~> Cell");
              __admitted();
              __with("justif := arith_simpl");
            },
        ...
        if (cn == 3) /*@cn*/ {
          ...
          __ghost(
              [&]() {
                __consumes(
                    "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 3, __TMP_1 - (- "
                    "1), 0)] ~> Cell");
                __produces(
                    "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 3, __TMP_1 + 1, "
                    "0)] ~> Cell");
                __admitted();
                __with("justif := arith_simpl");
              },
          ...
          __ghost(
              [&]() {
                __modifies(
                    "for __TMP_2 in range(0, 3 * (n - 1), 3) -> &D[MINDEX2(n, "
                    "3, exact_div(__TMP_2, 3) + 1, 0)] ~> Cell");
                __admitted();
                __with("justif := arith_simpl");
              },
              "");
          ...
          __ghost(
              [&]() {
                __modifies(
                    "for __TMP_2 in range(0, 3 * (n - 1), 3) -> &D[MINDEX2(n, "
                    "3, exact_div(__TMP_2, 3) + 1, 1)] ~> Cell");
                __admitted();
                __with("justif := arith_simpl");
              },
              "");
          ...
          __ghost(
              [&]() {
                __modifies(
                    "for __TMP_2 in range(0, 3 * (n - 1), 3) -> &D[MINDEX2(n, "
                    "3, exact_div(__TMP_2, 3) + 1, 2)] ~> Cell");
                __admitted();
                __with("justif := arith_simpl");
              },
              "");
          ...
          if (cn == 4) /*@cn*/ {
            ...
            __ghost(
                [&]() {
                  __consumes(
                      "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 4, __TMP_1 - (- "
                      "1), 0)] ~> Cell");
                  __produces(
                      "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, 4, __TMP_1 + "
                      "1, 0)] ~> Cell");
            ...
            __ghost(
                [&]() {
                  __modifies(
                      "for __TMP_2 in range(0, 4 * (n - 1), 4) -> "
                      "&D[MINDEX2(n, 4, exact_div(__TMP_2, 4) + 1, 0)] ~> "
                      "Cell");
                  __admitted();
                  __with("justif := arith_simpl");
                },
            ...
            __ghost(
                [&]() {
                  __modifies(
                      "for __TMP_2 in range(0, 4 * (n - 1), 4) -> "
                      "&D[MINDEX2(n, 4, exact_div(__TMP_2, 4) + 1, 1)] ~> "
                      "Cell");
                  __admitted();
                  __with("justif := arith_simpl");
                },
            ...
            __ghost(
                [&]() {
                  __modifies(
                      "for __TMP_2 in range(0, 4 * (n - 1), 4) -> "
                      "&D[MINDEX2(n, 4, exact_div(__TMP_2, 4) + 1, 2)] ~> "
                      "Cell");
                  __admitted();
                  __with("justif := arith_simpl");
                },
            ...
            __ghost(
                [&]() {
                  __modifies(
                      "for __TMP_2 in range(0, 4 * (n - 1), 4) -> "
                      "&D[MINDEX2(n, 4, exact_div(__TMP_2, 4) + 1, 3)] ~> "
                      "Cell");
                  __admitted();
                  __with("justif := arith_simpl");
                },
            ...
            for (int i = 0; i < 4 * (n - 1); i += 4) {
              ...
              __ghost_end(__ghost_pair_1227);
              __ghost_end(__ghost_pair_1126);
              __ghost(assume, "F := in_range(exact_div(i, 4), 0..n - 1)");
              __ghost(assume, "F := in_range(exact_div(i, 4) + 1, 1..n)");
              __ghost(assume,
                      "F := is_subrange(exact_div(i, 4) + kn..exact_div(i, 4) "
            ...
            for (int c = 0; c < cn; c++) {
              ...
              __ghost(
                  [&]() {
                    __consumes(
                        "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, cn, __TMP_1 "
                        "- (-1), c)] ~> Cell");
                    __produces(
                        "for __TMP_1 in 0..n - 1 -> &D[MINDEX2(n, cn, __TMP_1 "
                        "+ 1, c)] ~> Cell");
              ...
              __ghost(
                  [&]() {
                    __modifies(
                        "for __TMP_2 in range(0, cn * (n - 1), cn) -> "
                        "&D[MINDEX2(n, cn, exact_div(__TMP_2, cn) + 1, c)] ~> "
                        "Cell");
                    __admitted();
                    __with("justif := arith_simpl");
                  },
              ...
              __ghost(
                  [&]() {
                    __consumes(
                        "for __TMP_3 in range(0 + c, cn * (n - 1) + c, cn) -> "
                        "&D[MINDEX2(n, cn, exact_div((__TMP_3 - c), cn) + 1, "
                        "c)] ~> Cell");
                    __produces(
                        "for __TMP_3 in range(c, cn * (n - 1) + c, cn) -> "
                        "&D[MINDEX2(n, cn, exact_div((__TMP_3 - c), cn) + 1, "
                        "c)] ~> Cell");
                    __admitted();
                    __with("justif := arith_simpl");
