...
#include "variadic.h"   // macros    VARIADIC, NUMARG3
...
#define allocate_aligned_int_matrix(...) VARIADIC(allocate_aligned_int_matrix, NUMARG3(__VA_ARGS__), __VA_ARGS__)
...
/*
 * Matrix allocation - int_array* format.
...
/*
 * Matrix deallocation - int_array* format.
