#ifndef PIC_VERT_PARTICLE_TYPE_CHUNKBAGS_OF_SOA_2D
#define PIC_VERT_PARTICLE_TYPE_CHUNKBAGS_OF_SOA_2D

#include "meshes.h"     // type      cartesian_mesh_2d
#include "parameters.h" // constants VEC_ALIGN, NB_PARTICLE, CHUNK_SIZE, NB_PROC
 ...
 * @param[out] weight.
 * @param[out] particles[num_particle] a newly allocated array of randomized particles.
 */
...
#endif // ifndef PIC_VERT_PARTICLE_TYPE_CHUNKBAGS_OF_SOA_2D
