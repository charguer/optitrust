...
let printers_map = Longident.Map.of_seq (List.to_seq [
    ...
    (Lident "string", "Tools.string_to_ocaml_code");
    (Lident "var", "var_to_string");
    (Lident "mark", "Tools.string_to_ocaml_code");
    (Lident "vars", "vars_to_string");
    (Lident "option", "Tools.option_to_ocaml_code");
    (Lident "list", "Tools.list_to_ocaml_code");
    (Lident "trm", "Ast_to_c.ast_to_string");
