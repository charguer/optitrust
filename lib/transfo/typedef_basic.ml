...
let%transfo insert (name : string) (td_body : typedef_body) (tg : target) : unit =
  Trace.justif_always_correct ();
  Target.apply_at_target_paths_before (fun t i -> Typedef_core.insert_at name td_body i t) tg
