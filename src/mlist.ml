...
(* [of_list l]: create a mlist from a list of objects of type 'a *)
...
(* [rev ml]: apply List.rev to ml.items and ml.marks *)
let rev (ml : 'a t) : 'a t =
...
(* [remove start nb ml]: remove items that fall in the range [start, start + nb)  *)
