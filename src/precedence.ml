...
(* [precedence_prim p]: compute precedence of the primitive [p] *)
...
(* [precedence_trm t]: compute precedence of the trm [t] *)
...
(* [parentheses_needed ~prec t]: check if the precedence of [t] is greater then [prec] *)
