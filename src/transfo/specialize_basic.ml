...
let choose_fct (select_arg : var list -> int) : Target.Transfo.t =
...
let fundefs (spec_name : var) (spec_args : (trm option) list) (tg : target) : unit =
...
let funcalls (spec_name : var) (args_to_choose : bool list) : Transfo.t =
