...
(*TODO: in decode=false mode, the op_get should not be printed as star but as "op_get" *)
      ...
      (* show_path [cCall ~args:[cVar "p2"] ~validate:(List.mem true) ()] ~debug_ast:true; *)
      
      (* TODO: Fix the error with variable bound *)
      
      (* make_explicit_record_assignment ~struct_name:"particle" [cCall ~args:[cVar target ~name:"p_0" ()] ~validate:(List.mem true) ()]; *)
