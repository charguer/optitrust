...
typedef struct cartesian_mesh_1d {
...
typedef struct cartesian_mesh_2d {
    int num_cell_x; // number of cells on the x-axis
...
typedef struct tiled_cartesian_mesh_2d {
...
typedef struct cartesian_mesh_3d {
    int num_cell_x; // number of cells on the x-axis
    int num_cell_y; // number of cells on the y-axis
