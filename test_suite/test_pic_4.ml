...
let _ =
  run
    (fun _ ->
      ...
      insert_const ~insert_before:main_fun ~name:"nbColors" ~value:"0" ();
      insert_const ~insert_before:main_fun ~name:"nbCellsPerTile" ~value:"0" ();
      ...
      (*insert_decl ~insert_before:main_fun ~name:"idCellsOfTile[nbTiles][nbCellsPerTile]"();
      *)
      *)
      ...
      insert_and_fold ~insert_before ~name:"idTile" ~value:"temp / nbColors"();
      insert_decl ~insert_before ~name:"color" ~value:"temp % nbColors" ();
