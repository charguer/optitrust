...
void cell_update(Particle_symb* particles_symb,
  ...
  for (int idxPart = 0; idxPart < size; idxPart++) {
    particles_symb[idxPart].vx +=
        (particles_forces[idxPart].fx / particles_symb[idxPart].weight) *
        time_step;
    particles_symb[idxPart].vy +=
        (particles_forces[idxPart].fy / particles_symb[idxPart].weight) *
        time_step;
    particles_symb[idxPart].vz +=
        (particles_forces[idxPart].fz / particles_symb[idxPart].weight) *
        time_step;
...
int grid_create(double box_width, double cell_width,
  ...
  *particles_forces =
  ...
  for (int idxPart = 0; idxPart < src_size; idxPart++) {
    int cell_idx = grid_cell_idx_from_position(cell_width, nb_cells_per_dim,
...
void grid_compute(const int nb_cells_per_dim, int* sizes,
                  Particle_symb** particles_symb,
                  Particle_forces** particles_forces) {
        ...
        for (int idxPart = 0; idxPart < src_sizes[cell_idx]; idxPart++) {
          ...
          src_particles_symb[cell_idx][idxPart].vx +=
              (src_particles_forces[cell_idx][idxPart].fx /
               src_particles_symb[cell_idx][idxPart].weight) *
              time_step;
          ...
          int up_cell_idx = grid_cell_idx_from_position(
...
int main() {
  ...
  const int nb_cells_per_dim = grid_create(
      box_width, cell_width, cell.particles_symb, cell.particles_forces,
      cell.size, &sizes, &particles_symb, &particles_forces);
  cell_destroy(&cell);
