...
#pragma omp taskwait depend(in : *sizes, cell_idx[0], sizes, cell_idx) depend(inout : (*sizes)[*cell_idx])
      (*sizes)[*cell_idx]++;
...
#pragma omp taskwait depend(in : *sizes, sizes, up_cell_idx[0], up_cell_idx) depend(inout : (*sizes)[*up_cell_idx])
            (*sizes)[*up_cell_idx]++;
