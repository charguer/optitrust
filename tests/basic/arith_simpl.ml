...
let _ = Run.script_cpp (fun _ ->
    ...
    !! Arith_basic.(simpl ~indepth:false expand) [nbMulti; cFunDef "simpl_in_depth";cFun "g";dArg 0];
    ...
    !! Arith_basic.(simpl ~indepth:false identity) [nbMulti; cFunDef "simpl_in_depth"];
