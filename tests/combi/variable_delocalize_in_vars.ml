...
let _ =  Run.script_cpp ( fun () ->
  !! Variable.delocalize_in_vars ~index:"k" ~mark:"section_of_interest" ~var:"a" ~local_var:"x" ~var_type:(atyp "T") ~array_size:"N" ~ops:(Delocalize_arith (Lit_int 0, Binop_add) ) ~local_vars:["xa";"xb"] [cFor "i"];
