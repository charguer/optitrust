...
(* TODO: the insertion should be made  not at the top of the englobing sequence,
   but at the minimal index of all the targets in that sequence. In the example
   below, the array k should be inserted just before after the declaration of [t] *)
