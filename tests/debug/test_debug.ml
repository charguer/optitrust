...
let _ = Run.script_cpp (fun () ->
   ...
   (* -- Reorder Loops -- *)
   (* I assume the loop nest is not 'perfect' enough for:
   - 'blocking'
   ...
   *)
   ...
   !! Loop.hoist ~array_size:(Some (expr "32")) [cFunDef "mm"; cVarDef "sum"];
   !! Loop.hoist ~array_size:(Some (expr "32")) [cFunDef "mm"; cVarDef "sum_step"];
