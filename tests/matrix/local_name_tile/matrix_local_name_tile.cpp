...
void f() {
  ...
  for (int i = 0; i < 10; i++) {
    __modifies("Group(range(2, 10, 1), fun j -> "
               "Group(range(0, 4, 1), fun k -> &a[MINDEX3(10,10,4,i,j,k)] ~> Cell))");
    for (int j = 2; j < 10; j++) {
      __modifies("Group(range(0, 4, 1), fun k -> &a[MINDEX3(10,10,4,i,j,k)] ~> Cell)");
      for (int k = 0; k < 4; k++) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    for (int j = 2; j < 10; j++) {
      __writes("Group(range(0, 4, 1), fun k -> &b[MINDEX3(10,10,4,i,j,k)] ~> Cell)");
      for (int k = 0; k < 4; k++) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    for (int j = 2; j < 10; j++) {
      __writes("Group(range(0, 4, 1), fun k -> &c[MINDEX3(10,10,4,i,j,k)] ~> Cell)");
      for (int k = 0; k < 4; k++) {
    ...
    for (int j2 = 2; j2 < 10; j2++) {
      __writes("Group(range(0, 4, 1), fun k -> &c[MINDEX3(10,10,4,i,j2,k)] ~> Cell)");
