...
__ghost_ret matrix2_contiguous() {
  ...
  __consumes(
      ...
      "M(i, j)");
  __produces(
      "for k in (a * n1)..(b * n1) -> &matrix[MINDEX1(n2 * n1, k)] ~~> M(k / "
      "n1, k % n1)");
  __admitted();
}
...
__ghost_ret matrix3_contiguous() {
  ...
  __consumes(
      ...
      "&matrix[MINDEX3(n3, n2, n1, i1, i2, i3)] ~~> M(i3, i2, i1)");
  __produces(
      "for k in (a * n2 * n1)..(b * n2 * n1) -> &matrix[MINDEX1(n3 * n2 * n1, "
      "k)] ~~> M(k / n1 / n2, k / n1 % n2, k % n1)");
  __admitted();
}
...
__ghost_ret mindex2_contiguous() {
  ...
  __requires("M: int * int -> T");
  __consumes(
      "for i1 in a..b -> &matrix[MINDEX2(n2, n1, i2, i1)] ~~> M(i2, i1)");
  __produces(
...
__ghost_ret mindex3_contiguous() {
  ...
  __requires("M: int * int * int -> T");
  __consumes(
      "for i1 in a..b -> &matrix[MINDEX3(n3, n2, n1, i3, i2, i1)] ~~> M(i3, "
      "i2, i1)");
  __produces(
...
__ghost_ret mindex2_contiguous_ro() {
  ...
  __requires("f: _Fraction");
  __consumes(
      "_RO(f, for i1 in a..b -> &matrix[MINDEX2(n2, n1, i2, i1)] ~~> M(i2, "
      "i1))");
  __produces(
...
__ghost_ret mindex3_contiguous_ro() {
  ...
  __produces(
      ...
      "b) -> &matrix[MINDEX1(n3 * n2 * n1, k)] ~~> M(i3, i2, k % n1))");
  __admitted();
}
