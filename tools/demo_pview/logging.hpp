...
using namespace pasl::util::microtime;
...
// IMPORTANT: Don't modify this enum without modifying pview.ml accordingly
typedef enum {
  ENTER_LAUNCH = 0,
  EXIT_LAUNCH,
  ENTER_ALGO,
  ...
  ALGO_PHASE,
  LOCALITY_START,
  LOCALITY_STOP, // Pview treats constants until this one inclusive
  THREAD_START,
  THREAD_STOP,
  THREAD_CREATE,
  THREAD_SCHEDULE,
