...
# Lines 1,2,3,4,5,6 have specific behaviors, see below.
...
if [ "${LINE}" = "1" ]; then
  ...
  echo "==> Warning: this command probably won't work in vscode sandbox, if you don't have the watcher script."
